...
################################################################
# This is a generated script based on design: bass_fx_bd
#
...
ee_project:hls:process_sample:1.0\
...
proc create_root_design { parentCell } {
  ...
  set rgbleds_tri_o [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 rgbleds_tri_o ]

  set sw [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 sw ]


  # Create ports
  set audio_clk_10MHz [ create_bd_port -dir O audio_clk_10MHz ]
  set bclk_0 [ create_bd_port -dir O bclk_0 ]
  set codec_address_0 [ create_bd_port -dir O -from 1 -to 0 codec_address_0 ]
  ...
  set_property CONFIG.C_CODEC_ADDRESS {11} $audio_codec_ctrl_0
  ...
  set_property CONFIG.FIFO_DEPTH {512} $axis_data_fifo_1


  # Create instance: clk_oddr_0, and set properties
  set block_name clk_oddr
  set block_cell_name clk_oddr_0
  if { [catch {set clk_oddr_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clk_oddr_0 eq "" } {
  ...
  # Create instance: process_sample_0, and set properties
  set process_sample_0 [ create_bd_cell -type ip -vlnv ee_project:hls:process_sample:1.0 process_sample_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports rgbleds_tri_o] [get_bd_intf_pins axi_gpio_2/GPIO]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins process_sample_0/s_in]
  ...
  connect_bd_intf_net -intf_net process_sample_0_s_out [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins process_sample_0/s_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins process_sample_0/s_axi_ctrl] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net audio_codec_ctrl_0_bclk [get_bd_ports bclk_0] [get_bd_pins audio_codec_ctrl_0/bclk]
  connect_bd_net -net audio_codec_ctrl_0_codec_address [get_bd_ports codec_address_0] [get_bd_pins audio_codec_ctrl_0/codec_address]
  connect_bd_net -net audio_codec_ctrl_0_lrclk [get_bd_ports lrclk_0] [get_bd_pins audio_codec_ctrl_0/lrclk]
  connect_bd_net -net audio_codec_ctrl_0_sdata_o [get_bd_ports sdata_o_0] [get_bd_pins audio_codec_ctrl_0/sdata_o]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net clk_oddr_0_clk_out [get_bd_ports audio_clk_10MHz] [get_bd_pins clk_oddr_0/clk_out]
  connect_bd_net -net clk_wiz_10MHz_clk_out1 [get_bd_pins clk_oddr_0/clk_in] [get_bd_pins clk_wiz_10MHz/clk_out1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins audio_codec_ctrl_0/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins clk_wiz_10MHz/clk_in1] [get_bd_pins process_sample_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins audio_codec_ctrl_0/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins clk_wiz_10MHz/resetn] [get_bd_pins process_sample_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sdata_i_0_1 [get_bd_ports sdata_i_0] [get_bd_pins audio_codec_ctrl_0/sdata_i]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs audio_codec_ctrl_0/S_AXI/reg0] -force
  ...
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x40800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_iic_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs process_sample_0/s_axi_ctrl/Reg] -force
