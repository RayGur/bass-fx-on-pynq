"""
codec_init.py — Phase 6 啟動腳本
1. 載入 overlay（新 Phase 6 bitstream）
2. 初始化 ADAU1761 codec via AXI IIC
3. 結束（PL 狀態保留，再跑 sudo ./audio_dma）
...
BIT_PATH   = "/home/xilinx/bass_fx_bd.bit"
IIC_BASE   = 0x40800000   # axi_iic_0 base address
IIC_RANGE  = 0x10000
CODEC_ADDR = 0x3B         # ADAU1761 I2C slave address
...
# ── ADAU1761 init (same sequence as pio_loop.py) ──────────────
print("Initialising ADAU1761...")

# --- PLL: 10 MHz MCLK → 49.152 MHz → 48 kHz ---
iic_write(0x00, 0x0E)   # disable core clock
...
iic_write(0x00, 0x0F)   # enable core clock (PLL source)
